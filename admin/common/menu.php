...
<div class="sidebar" data-color="yh">
    	...
    	<div class="sidebar-wrapper">
            ...
            <br/> <br/>
               ...
               <a href="../dashboard/dashboard.php"><img src="../common/core-img/passport.jpg"  width="195" height="140"></a> 
            ...
            <ul class="nav">
                ...
                <li >
                 ...
                 <li>
                    <a href="../doctor/select.php">
                        <i class="pe-7s-user"></i>
                         <p style="font-size:18px">Doctors </p>
                    </a>
					
                </li>
                   <li>
                    <a href="../disease/select.php">
                        <i class="pe-7s-bandaid"></i>
                         <p style="font-size:18px">disease</p>
                    </a>
