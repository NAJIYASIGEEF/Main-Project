...
elseif($i==3 )
  {
	  echo "<div class='col-md-10'>
               <div class='form-group'>
				...
				$result3 = mysqli_query($con, $sql2) or die("Error in Selecting " . mysqli_error($connection));
				
				echo "<select name='$name' class='form-control'>";
				echo "<option value='$row2[id]'>$datas</option>";
				while($row3 =mysqli_fetch_array($result3))
				{
					echo "<option value='$row3[id]'>$row3[specialization]</option>";
				}
				echo "</select>";
				echo "</div>
                      </div>";
